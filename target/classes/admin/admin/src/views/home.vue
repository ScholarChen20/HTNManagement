<template>
<div class="content" :style='{"minHeight":"100vh","padding":"20px 30px 20px","alignItems":"flex-start","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20240401/912a53b6ea3c493aa71a64914c7f0b0e.png) no-repeat center top / cover","display":"flex","fontSize":"14px","height":"auto"}'>
	<!-- notice -->
	<!-- title -->
