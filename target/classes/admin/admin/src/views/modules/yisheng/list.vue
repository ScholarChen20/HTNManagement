		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #eee","width":"100%","padding":"0","margin":"20px 0 0","borderRadius":"0px","background":"rgba(255,255,255,.9)"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column :resizable='true' :sortable='true' prop="yishizigezheng" label="医师资格证">
						<template slot-scope="scope">
							<el-button v-if="scope.row.yishizigezheng" type="text" size="small" @click="download(scope.row.yishizigezheng)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					<el-table-column :resizable='true' :sortable='true'  
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('yisheng','排班')" @click="zuozhenyishengCrossAddOrUpdateHandler(scope.row,'cross','是','','','')" type="success">
