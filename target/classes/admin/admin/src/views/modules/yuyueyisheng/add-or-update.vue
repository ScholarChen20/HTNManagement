		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="挂号费用" prop="guahaofeiyong">
					<el-input v-model="ruleForm.guahaofeiyong" placeholder="挂号费用" clearable  :readonly="ro.guahaofeiyong"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="病情描述" prop="bingqingmiaoshu">
					<el-input
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.bingqingmiaoshu" label="病情描述" prop="bingqingmiaoshu">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"inherit","background":"none","fontWeight":"500","display":"inline-block"}'>{{ruleForm.bingqingmiaoshu}}</span>
				</el-form-item>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.huanzheshouji!=''&&json.huanzheshouji) || json.huanzheshouji==0) && this.$storage.get("role")!="管理员"){
						this.ruleForm.huanzheshouji = json.huanzheshouji
						this.ro.huanzheshouji = true;
					}
				} else {
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `yuyueyisheng/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.yuyueyishengCrossAddOrUpdateFlag = false;
											this.parent.search();
