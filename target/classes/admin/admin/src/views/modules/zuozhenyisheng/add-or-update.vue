	...
	<div class="addEdit-block" :style='{"padding":"30px 0","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="科室" prop="keshi">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="职称" prop="zhicheng">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="挂号费用" prop="guahaofeiyong">
					<el-input v-model.number="ruleForm.guahaofeiyong" placeholder="挂号费用" clearable  :readonly="ro.guahaofeiyong"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="挂号费用" prop="guahaofeiyong">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="排班时段" prop="paibanshiduan">
					<el-input v-model="ruleForm.paibanshiduan" placeholder="排班时段" clearable  :readonly="ro.paibanshiduan"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="排班时段" prop="paibanshiduan">
					<el-input v-model="ruleForm.paibanshiduan" placeholder="排班时段" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='paibanshiduan'){
							this.ruleForm.paibanshiduan = obj[o];
							this.ro.paibanshiduan = true;
							continue;
						}
						if(o=='yishengjianjie'){
