<template>
	<div class="navbar">
		<div class="title" :style='{"margin":"0","alignItems":"center","textAlign":"center","left":"450px","background":"none","display":"flex","width":"auto","position":"absolute","order":"1"}'>
			<el-image v-if="true" class="title-img" :style='{"width":"auto","objectFit":"cover","borderRadius":"20%","height":"50px"}' src="http://codegen.caihongy.cn/20240316/baf68052f3ce43889964501740ca79df.png" fit="cover" />
			<span class="title-name" :style='{"padding":"0 0 0 20px","lineHeight":"44px","fontSize":"16px","color":"#333","fontWeight":"600"}'>{{this.$project.projectName}}</span>
		</div>
		<!--
