...
<mescroll-uni @init="mescrollInit" :up="upOption" :down="downOption" @down="downCallback" @up="upCallback">
	<view class="content">
		<view class="container" :style='{"minHeight":"100vh","width":"100%","padding":"24rpx 24rpx 24rpx","position":"relative","background":"#eefcff","height":"auto"}'>
				...
				<view :style='{"padding":"0 24rpx","margin":"0","borderColor":"#76c4d8","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
					<view :style='{"padding":"0 20rpx 0 0","borderColor":"#76c4d8","whiteSpace":"nowrap","color":"#333","borderRadius":"0","textAlign":"right","borderWidth":"0 0 2rpx","width":"auto","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}' class="lable">科室：</view>
					<view :style='{"padding":"16rpx 0 0","wordBreak":"break-all","margin":"0px","borderColor":"#76c4d8","color":"#666","borderWidth":"0 0 2rpx","flex":"1","lineHeight":"48rpx","fontSize":"28rpx","borderStyle":"solid"}' class="text">{{detail.keshi}}</view>
				</view>
				<view :style='{"padding":"0 24rpx","margin":"0","borderColor":"#76c4d8","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}' class="detail-list-item title">
				...
				<view class="detail-list-item" :style='{"padding":"0 24rpx","margin":"0","borderColor":"#76c4d8","borderRadius":"0","borderWidth":"0 0 0px 0","background":"#fff","display":"flex","width":"100%","borderStyle":"solid","height":"auto"}'>
					<view class="lable" :style='{"padding":"0 20rpx 0 0","borderColor":"#76c4d8","whiteSpace":"nowrap","color":"#333","borderRadius":"0","textAlign":"right","borderWidth":"0 0 2rpx","width":"auto","lineHeight":"80rpx","fontSize":"28rpx","borderStyle":"solid"}'>排班时段：</view>
					<view  class="text" :style='{"padding":"16rpx 0 0","wordBreak":"break-all","margin":"0px","borderColor":"#76c4d8","color":"#666","borderWidth":"0 0 2rpx","flex":"1","lineHeight":"48rpx","fontSize":"28rpx","borderStyle":"solid"}'>{{detail.paibanshiduan}}</view>
				</view>
				...
				<view class="bottom-content bg-white tabbar border shop" :style='{"padding":"24rpx 0","margin":"0 auto","borderRadius":"0","flexWrap":"wrap","background":"none","display":"flex","width":"100%","height":"auto","order":"2"}'>
					...
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 3% 20rpx 0","color":"rgb(255, 255, 255)","borderRadius":"60rpx","background":"#76c4d8","width":"auto","fontSize":"28rpx","minWidth":"21%","lineHeight":"80rpx","height":"80rpx"}' v-if="userid&&isAuth('zuozhenyisheng','预约医生')" @tap="onAcrossTap('yuyueyisheng','','','','')" class="cu-btn bg-brown round shadow-blur" >预约医生</button>
					<button :style='{"border":"0","padding":"0 20rpx","margin":"0 3% 20rpx 0","color":"rgb(255, 255, 255)","borderRadius":"60rpx","background":"#76c4d8","width":"auto","fontSize":"28rpx","minWidth":"21%","lineHeight":"80rpx","height":"80rpx"}' v-if="!userid&&isAuthFront('zuozhenyisheng','预约医生')" @tap="onAcrossTap('yuyueyisheng','','','','')" class="cu-btn bg-brown round shadow-blur" >预约医生</button>
	...
	export default {
		...
		async onShow(options) {
            ...
            if(crossCleanType) {
                ...
                res = await this.$api.info('zuozhenyisheng', this.id);
		...
		methods: {
			...
			async init(type=1){
				...
				let res = await this.$api.info('zuozhenyisheng', this.id);
				this.detail = res.data;
				...
				if(type==2){
					...
					await this.$api.update('zuozhenyisheng',this.detail)
				}
			},
